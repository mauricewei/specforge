...
%preun -n blackswan-server
%systemd_preun blackswan-server

%preun -n blackswan-watcher
%systemd_preun blackswan-watcher

%post -n blackswan-server
%systemd_postun blackswan-server.service

%post -n blackswan-watcher
%systemd_postun blackswan-watcher.service
