...
Requires:         python2-barbicanclient
...
#/usr/bin/cp -arf %{service}/templates %{buildroot}%{_sysconfdir}/%{service}/
...
#%config(noreplace) %attr(0750, root, %{service}) %{_sysconfdir}/%{service}/templates
